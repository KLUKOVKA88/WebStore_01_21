    ...
    public class WebStoreDbInitializer
    {
        ...
        public void Initialize() 
        {
            ...
            if(db.GetPendingMigrations().Any())
            {
               ...
               _Logger.LogInformation("База данных находится в актуальном версии ({0:0.0###} c)",
           ...
           async Task CheckRole(string RoleName)
            {
                ...
                {
                    _Logger.LogInformation("Роль {0} отсутсвует. Создаю...");
            ...
            {
                _Logger.LogInformation("Отсутсвует учётная запись администратора");
                var admin = new User
                {
